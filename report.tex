...
In addition, other scientific fields, such as epidemiology or taxonomy, apply MST algorithms to compute medical results.
Examples of problems that can be solved using MST algorithms include
\begin{itemize}
...
using different component representation and work distribution strategies. Our implementations use the Message Passing
Interface (MPI) for work distribution and communication. To evaluate the performance of our implementations, we use
