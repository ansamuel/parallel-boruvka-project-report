...
The number of MPI processes in this study were the powers of $2$: $2^0, \dotsc 2^6$. The baseline implementation did not
allow us to go any furhter than that because the execution took too long. We believe this to be an implementation issue
...
was performed using graphs wth $2^{20}$ vertices. The number of MPI processes were the powers of $2$: $2^0, \dotsc,
2^9$.
The weak scaling study was performed using the following configurations: \\
\begin{table}[h!]
\centering
...
by performing $10$ repetitions in all benchmarks, whhere the first execution is discarded due to warmup.
