...
was equal on all nodes. This allocation strategy should lead to more consisten measurements because of the following
reason. Benchmarks with a low MPI core count could have an unfair advantage due to less network communication.
