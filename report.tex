...
% Title.
% ------
\title{Efficient Parallelization of Boruvka's Minimum Spanning Tree Algorithm}
...
\fiveauthors
  ...
  {Simon Hrabec \\[-0.8ex] {\small MS Computer Science} \\[-0.8ex] {\small \texttt{shrabec@ethz.ch}}}
