...
At first glance, MST algorithms seem to only have a very limited applicability. However, they can often be used as part
of other algorithms to compute intermediate results or in other scientific fields, such as medicine. Examples of
problems that can be solved using MST algorithms include
\begin{itemize}
