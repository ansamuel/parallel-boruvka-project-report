...
average degree of $32$. The implementation \emph{Edge Distributed Pointer Jumping} resulted in bad performance  and we
decided to not include it in our reported measurements.
