...
\begin{figure}
  ...
  \caption{Strong Scaling Study w/o the baseline. Vertex count $2^{20}$.}
  \label{fig:scrongscaling-20}
\end{figure}
%Strong scaling, skip boost, size 20 -> line plot

Like can be seen in Fig. \ref{fig:scrongscaling-20} all implementation have an improved runtime as the MPI processes increases up and including 4 processes.
