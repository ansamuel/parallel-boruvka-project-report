...
decided to only benchmark Kronecker graphs. Self-written generators can be error-prone and it is difficult to
...
we also use scatter, gather and reduction functionalities. To minimize the communication, we first prepare data locally
and send data in bulk. This was used to e.g. more efficiently distribute the incident edges in all vertex distributed
implementations.
