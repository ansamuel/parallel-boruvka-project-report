...
Randomly generated Kronecker graphs are used to evaluate the performance of our implementation. In this paper we present a parallel MST implementation which performs multiple times better than the Parallel BGL implementation. % TODO, do we want to call PGL state-of-the-art?
