...
algorithm execution were summarized by taking the maximum time taken by any MPI process. To get a summary over all
...
$8$ or less MPI processes. For more than $8$ MPI processes, only the edge distributed algorithms outperform the
baseline. We verified that these reults are statistically significant by making sure that the $90\%$ confidence
