...
was equal on all nodes. This allocation strategy should lead to more consisten measurements, because benchmarks with a
low MPI core count could have an unfair advantage due to less network communication.
